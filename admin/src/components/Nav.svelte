<script>
  ...
  $: expandedGroups = {
    ...
    infra: navGroups[5].children.some(c => c.href === $selectedNav) || !collapsedGroups.infra,
  };
  ...
  const navGroups = [
    ...
    },
    {
      ...
      children: [
        { href: '/sandboxes', label: 'Sandboxes', icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>` }
      ]
    }
  ];
