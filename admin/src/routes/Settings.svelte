...
<div class="p-6 max-w-4xl mx-auto fade-in">
  ...
  {#if loading}
    <div class="bg-white rounded-xl border border-gray-200 shadow-card p-8 text-center">
      <p class="text-gray-400 text-sm">Loading server status...</p>
    </div>
  {:else if error}
    <div class="bg-white rounded-xl border border-gray-200 shadow-card p-8 text-center">
  ...
  <div class="space-y-5">
    <div class="bg-white rounded-xl border border-gray-200 shadow-card">
      <div class="px-6 py-4 border-b border-gray-100">
        <h2 class="font-semibold text-gray-900 text-sm">Evaluation Webhooks</h2>
        <p class="text-gray-400 text-xs mt-0.5">Receive evaluation events at multiple endpoints</p>
      </div>
      <div class="p-6">
        <div class="mb-4">
          <label for="webhook-urls" class="block text-sm font-semibold text-gray-500 mb-2">
            Webhook URLs <span class="text-gray-400 font-normal">(comma-separated or one per line)</span>
          </label>
          <textarea
            id="webhook-urls"
            readonly
          ...
          <p class="text-gray-400 text-xs mt-2">
            Set via <code class="bg-gray-200 px-1 rounded">AION_HIVE_EVAL_WEBHOOK_URLS</code> environment variable
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-card">
      <div class="px-6 py-4 border-b border-gray-100">
        <h2 class="font-semibold text-gray-900 text-sm">Environment</h2>
        <p class="text-gray-400 text-xs mt-0.5">Runtime configuration</p>
      </div>
      <div class="p-6">
        <div class="grid grid-cols-2 gap-4">
          <div class="bg-gray-50 rounded-lg p-4 border border-gray-100">
            <p class="text-gray-400 text-[11px] uppercase tracking-wider font-semibold mb-1.5">Version</p>
            <p class="text-gray-900 font-mono text-sm font-semibold">v{status.version}</p>
          </div>
          <div class="bg-gray-50 rounded-lg p-4 border border-gray-100">
            <p class="text-gray-400 text-[11px] uppercase tracking-wider font-semibold mb-1.5">Transport</p>
            <p class="text-gray-900 font-mono text-sm font-semibold">{status.transport_mode}</p>
          </div>
          <div class="bg-gray-50 rounded-lg p-4 border border-gray-100">
            <p class="text-gray-400 text-[11px] uppercase tracking-wider font-semibold mb-1.5">HTTP Port</p>
            <p class="text-gray-900 font-mono text-sm font-semibold">{status.http_port}</p>
          </div>
          <div class="bg-gray-50 rounded-lg p-4 border border-gray-100">
            <p class="text-gray-400 text-[11px] uppercase tracking-wider font-semibold mb-1.5">Data Directory</p>
            <p class="text-gray-900 font-mono text-sm font-semibold">{status.data_dir}</p>
          </div>
          <div class="bg-gray-50 rounded-lg p-4 border border-gray-100">
            <p class="text-gray-400 text-[11px] uppercase tracking-wider font-semibold mb-1.5">Skills Directory</p>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-card">
      <div class="px-6 py-4 border-b border-gray-100">
        <h2 class="font-semibold text-gray-900 text-sm">Security</h2>
      ...
      <div class="p-6">
        <div class="space-y-4">
          <div class="flex items-center justify-between py-2">
            <div>
              <p class="text-gray-900 font-semibold text-sm">JWT Token Expiry</p>
              <p class="text-gray-400 text-xs">{status.jwt_expiry_hours} hours</p>
            </div>
            <span class="inline-flex px-2.5 py-1 text-xs font-semibold rounded-full bg-emerald-50 text-emerald-600 ring-1 ring-emerald-500/20">Configured</span>
          </div>
          <div class="flex items-center justify-between py-2 border-t border-gray-100">
            <div>
              <p class="text-gray-900 font-semibold text-sm">Secret Key</p>
              <p class="text-gray-400 text-xs">Environment variable</p>
            </div>
            <span class="inline-flex px-2.5 py-1 text-xs font-semibold rounded-full bg-emerald-50 text-emerald-600 ring-1 ring-emerald-500/20">Set</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-card">
      <div class="px-6 py-4 border-b border-gray-100">
        <h2 class="font-semibold text-gray-900 text-sm">Database</h2>
        <p class="text-gray-400 text-xs mt-0.5">PostgreSQL connection</p>
      </div>
      <div class="p-6">
