...
pub fn create_api_router(state: ApiState) -> Router<ApiState> {
    Router::new()
        ...
        .route("/api/v1/skills/:id/submit-review", post(submit_review_skill_handler))
        .route("/api/v1/skills/:id/approve", post(approve_org_skill_handler))
        ...
        .route("/api/v1/skills/:id/groups", post(add_skill_to_group_handler))
        .route("/api/v1/skills/:id/groups/:group_id", delete(remove_skill_from_group_handler))
        ...
        .route("/api/v1/orgs/:slug/groups/:group_id", get(get_org_group_handler))
        .route("/api/v1/orgs/:slug/groups/:group_id", put(update_org_group_handler))
        .route("/api/v1/orgs/:slug/groups/:group_id", delete(delete_org_group_handler))
        // Org slug-based Group member management (6.6)
        .route("/api/v1/orgs/:slug/groups/:group_id/members", get(list_org_group_members_handler))
        .route("/api/v1/orgs/:slug/groups/:group_id/members/:username", put(update_org_group_member_handler))
        .route("/api/v1/orgs/:slug/groups/:group_id/members/:username", delete(remove_org_group_member_handler))
        // Org slug-based Group-Skill association (6.6)
        .route("/api/v1/orgs/:slug/groups/:group_id/skills", get(list_org_group_skills_handler))
        .route("/api/v1/orgs/:slug/groups/:group_id/skills", post(add_org_group_skill_handler))
        .route("/api/v1/orgs/:slug/groups/:group_id/skills/:skill_id", delete(remove_org_group_skill_handler))
        ...
        .route("/api/v1/orgs/:slug/members", get(list_org_members_by_slug_handler))
        .route("/api/v1/orgs/:slug/members", post(invite_org_member_handler))
        .route("/api/v1/orgs/id/:org_id/members", get(list_org_members_by_id_handler))
        .route("/api/v1/orgs/id/:org_id/members/invite", post(invite_org_member_by_id_handler))
        .route("/api/v1/orgs/id/:org_id/members/:username", put(update_org_member_by_id_handler))
        .route("/api/v1/orgs/id/:org_id/members/:username", delete(remove_org_member_by_id_handler))
        .route("/api/v1/orgs/:slug/members/:username", put(update_org_member_handler))
        .route("/api/v1/orgs/:slug/members/:username", delete(remove_org_member_by_slug_handler))
        // Group member management (6.6)
        .route("/api/v1/groups/:id/members", get(list_group_members_handler))
        .route("/api/v1/groups/:id/members", post(add_group_member_handler))
        .route("/api/v1/groups/:id/members/:agent_id", put(update_group_member_handler))
        .route("/api/v1/groups/:id/members/:agent_id", delete(remove_group_member_handler))
        // Group permission management
        .route("/api/v1/groups/default-permissions", get(list_group_default_permissions_handler))
        .route("/api/v1/groups/:id/permissions", get(list_group_permissions_handler))
        .route("/api/v1/groups/:id/permissions", put(update_group_permission_handler))
        .route("/api/v1/groups/:id/permissions/:permission_code", delete(delete_group_permission_handler))
        // Organization member routes
        .route("/api/v1/admin/orgs/:org_id/members", get(list_org_members_handler))
        .route("/api/v1/admin/orgs/:org_id/members", post(add_org_member_handler))
        .route("/api/v1/admin/orgs/:org_id/members/:agent_id", delete(remove_org_member_handler))
        .route("/api/v1/admin/orgs/:org_id/stats", get(get_org_stats_handler))
        // Session routes
        ...
        .route("/api/v1/admin/sandboxes/health", get(get_sandbox_health_handler))
        .route("/api/v1/admin/sandboxes/:key", delete(remove_sandbox_handler))
        .route("/api/v1/tools/execute", post(execute_tool_handler))
        // Git Proxy routes
        .route("/api/v1/admin/git/:repo_id/branches", get(list_git_branches_handler))
        .route("/api/v1/admin/git/:repo_id/commits/:limit", get(get_git_commits_handler))
        .route("/api/v1/admin/git/:repo_id/file/*path", get(get_git_file_handler))
        .route("/api/v1/admin/git/:repo_id/diff/:from/:to", get(get_git_diff_handler))
        .route("/api/v1/admin/git/validate", post(validate_git_url_handler))
        .route("/api/v1/admin/git/health", get(get_git_proxy_health_handler))
        // Tenant routes
        ...
        .route("/api/v1/admin/identities/:id", delete(delete_identity_handler))
        // Group routes
        ...
        // Audit Log Entries
        .route("/api/v1/admin/audit-entries", get(list_audit_entries_handler))
        .with_state(state)
}